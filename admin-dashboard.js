...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const renderBhItem = (house) => {
    ...
    return `
      <li class="list-group-item d-flex justify-content-between align-items-center bh-list-item status-${house.status}" id="bh-item-${house.id}" data-house-data='${JSON.stringify(house)}'>
        <div>
  ...
  const renderUserItem = (user) => {
    ...
    return `
      <li class="list-group-item d-flex justify-content-between align-items-center" data-user-data='${JSON.stringify(user)}'>
        <div class="d-flex align-items-center">
